...
part1.controller('Working',
  function($scope) {
        ...
        stage01_merchant: {
          genesis: {
            metadata: {
              ...
              nonce: nonce,
              expiration_date: metadataExpDate
            },
            item_data: {
              title: itemTitle,
              ...
              images: {
                image1: {
                  image_link1: itemImage1,
                  image_hash1: itemImageHash1
                },
                image2: {
                  image_link2: itemImage2,
                  image_hash2: itemImageHash2
                },
                image3: {
                  image_link3: itemImage3,
                  image_hash3: itemImageHash3
                },
                image4: {
                  image_link4: itemImage4,
                  image_hash4: itemImageHash4
                },
                image5: {
                  image_link5: itemImage5,
                  image_hash5: itemImageHash5
                }
              },
              ...
              region: itemRegion,
              estimated_delivery: itemEstDelivery
            },
            merchant: {
              guid: merchantGUID,
              handle: merchantHandle,
              legal_address: merchantLegalAddress,
              pubkeys: {
                pgp: merchantPGPPubkey,
                bitcoin_pubkey: merchantECPubkey
              }
            }
          },
          signatures: {
    ...
    $scope.save_stage01 = function () {
      var crap = JSON.parse($scope.display1);
      console.log(crap);
      localStorage.setItem('dascontract', JSON.stringify(crap));
      var data = "text/json," + encodeURIComponent(JSON.stringify(crap, null, 4));
      $('<a href="data:' + data + '" download="Stage01_merchant_contract.json">Download Contract</a>').appendTo('#container');    };
    $scope.start2 = function() {
      ...
      $scope.view2 = true;
      stage02.stage02_buyer = {
        buyer: {
          contract_to_buy: importconctractHash,
          guid: buyerGUID,
          handle: buyerHandle,
          legal_address: buyerLegalAddress,
          pubkeys: {
            pgp: buyerPGPPubkey,
            secp256k1_uncompressed: buyerECPubkey
          }
        },
        signatures: {
          pgp: buyerDigiSig
    ...
    $scope.start3 = function() {
      ...
      stage03.stage03_notary = {
        notary: {
          contract_to_notarise: importconctractHashnotary,
          guid: notaryGUID,
          handle: notaryHandle,
          legal_address: notaryLegalAddress,
          pubkeys: {
            pgp: notaryPGPPubkey,
            secp256k1_uncompressed: notaryECPubkey
          },
          escrow: {
            multisig_address: multisigescrow,
            multisig_redemption_script: multisigredemption
          }
        },
        signatures: {
          pgp: notaryDigiSig
    ...
    $scope.start4 = function() {
      ...
      stage04.stage04_escrowfunding = {
        funding_evidence: {
          contract_to_fund_escrow: importconctractTriple,
          transaction_id: txID,
          ship_to_this_address: shiptoAddr
        },
        signatures: {
          pgp: buyerDigitalSig
        }
    ...
    $scope.start5 = function() {
      ...
      stage05.stage05_shipment = {
        shipment: {
          contract_for_shipping: importconctractShip,
          shipping_info: {
            shipper_ID: shipperID,
            shipper_address: shipperAddr,
            shipping_tracking_number: shipperTracker
          },
          releasefunds: {
            signed_tx: merchantSignedTx
          }
        },
        signatures: {
          pgp: stage05_merchantDigitalSig
        }
      };
    ...
    $scope.start6 = function() {
      ...
      stage06.stage06_release = {
        release_funds: {
          contract_to_release_funds: stage05contractHash,
          contract_status: contractStatus,
          message: message2,
          signed_tx: buyerSignedTx,
          transaction_id: releaseTXID
        },
        signatures: {
          pgp: stage06_buyerDigitalSig
        }
      };
